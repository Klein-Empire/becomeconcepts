      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex items-center justify-between py-4">
          <div className="flex items-center space-x-4">
            <h1 className="text-2xl font-bold text-slate-900">NewsDaily</h1>
          </div>
        ...
        <nav className="hidden md:block border-t border-slate-200">
          <div className="flex items-center space-x-8 py-3">
            <a href="/" className="text-slate-900 hover:text-blue-600 font-medium transition-colors">
              Home
            </a>
        ...
        {isMenuOpen && (
          <div className="md:hidden border-t border-slate-200 py-4">
            <div className="flex flex-col space-y-3">
              <a href="/" className="text-slate-900 hover:text-blue-600 font-medium">
                Home
              </a>
              {categories.map((category) => (
                <a
