...
const Admin = () => {
  ...
  const [crawlNews, setCrawlNews] = useState<CrawlNews[]>([
    { 
      ...
      isActive: true,
      interactions: { views: 245, likes: 12, comments: [] }
    },
    { 
      id: 2, 
      ...
      isActive: true,
      interactions: { views: 189, likes: 8, comments: [] }
    }
  ]);
  ...
  const [publications, setPublications] = useState<Publication[]>([
    {
      ...
      isActive: true,
      interactions: { views: 456, likes: 23, comments: [] }
    }
  ]);
  ...
  const [teachings, setTeachings] = useState<Teaching[]>([
    {
      ...
      level: 'Beginner',
      isActive: true,
      interactions: { views: 324, likes: 18, comments: [] }
    }
  ]);
  ...
  const handleSavePublication = () => {
    ...
    if (editingPublication) {
      ...
      const newPublication: Publication = {
        ...
        image: imageUrl,
        pdf: pdfUrl,
        interactions: { views: 0, likes: 0, comments: [] }
      };
  ...
  const handleSaveTeaching = () => {
    ...
    if (editingTeaching) {
      setTeachings(teachings.map(teach => 
        teach.id === editingTeaching.id 
          ? { 
              ...teach, 
              ...teachingFormData, 
              image: imageUrl,
  ...
  const togglePublicationStatus = (id: number) => {
    setPublications(publications.map(pub => 
      pub.id === id ? { ...pub, isActive: !pub.isActive } : pub
    ));
  };

  const toggleTeachingStatus = (id: number) => {
    setTeachings(teachings.map(teach => 
      teach.id === id ? { ...teach, isActive: !teach.isActive } : teach
    ));
  };
          ...
          <TabsContent value="crawl" className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200">
              <div className="space-y-6 p-6">
                {crawlNews.map((crawl) => (
                  <div key={crawl.id} className="border border-gray-200 rounded-xl p-6 hover:bg-gray-50">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center space-x-4 flex-1">
                        ...
                        {crawl.image && (
                          <img src={crawl.image} alt="News" className="w-12 h-12 rounded-full object-cover border-2 border-gray-200" />
                        )}
                    ...
                    <InteractionTracker
                      itemId={crawl.id}
                      itemType="news"
                      interactions={crawl.interactions}
                      onUpdateInteractions={(interactions) => updateCrawlInteractions(crawl.id, interactions)}
                      isAdmin={true}
                    />
                  </div>
                ))}
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200">
              <div className="space-y-6 p-6">
                {publications.map((publication) => (
                  <div key={publication.id} className="border border-gray-200 rounded-xl p-6 hover:bg-gray-50">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center space-x-4 flex-1">
                        <button
                    ...
                    <InteractionTracker
                      ...
                      onUpdateInteractions={(interactions) => updatePublicationInteractions(publication.id, interactions)}
                      isAdmin={true}
                    />
                  </div>
                ))}
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200">
              <div className="space-y-6 p-6">
                {teachings.map((teaching) => (
                  <div key={teaching.id} className="border border-gray-200 rounded-xl p-6 hover:bg-gray-50">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center space-x-4 flex-1">
                        <button
                        ...
                        {teaching.image && (
                          <img src={teaching.image} alt={teaching.courseName} className="w-16 h-12 object-cover rounded-lg" />
                        )}
                        ...
                        <div className="flex-1">
                          ...
                          {teaching.pdf && (
                            <Button
                              ...
                              size="sm"
                              className="mt-2 border-green-600 text-green-600 hover:bg-green-600 hover:text-white"
                              onClick={() => window.open(teaching.pdf, '_blank')}
                            >
                              <Download className="h-4 w-4 mr-1" />
                              Download Materials
                            </Button>
                    ...
                    <InteractionTracker
                      itemId={teaching.id}
                      itemType="teaching"
                      interactions={teaching.interactions}
                      onUpdateInteractions={(interactions) => updateTeachingInteractions(teaching.id, interactions)}
                      isAdmin={true}
                    />
                  </div>
                ))}
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setPublicationFormData({...publicationFormData, year: e.target.value})}
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200"
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) => setPublicationFormData({...publicationFormData, abstract: e.target.value})}
                  placeholder="Brief publication abstract"
                  rows={3}
              ...
              <FileUpload
                ...
                accept="image/*"
                type="image"
                preview={editingPublication?.image}
                onFileSelect={(file) => setPublicationFormData({...publicationFormData, image: file})}
              />
              ...
              <FileUpload
                ...
                accept=".pdf"
                type="pdf"
                onFileSelect={(file) => setPublicationFormData({...publicationFormData, pdf: file})}
              />
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    type="text"
                    value={teachingFormData.courseName}
                    onChange={(e) => setTeachingFormData({...teachingFormData, courseName: e.target.value})}
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  ...
                  <input
                    type="text"
                    value={teachingFormData.semester}
                    onChange={(e) => setTeachingFormData({...teachingFormData, semester: e.target.value})}
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200"
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={teachingFormData.year}
                    onChange={(e) => setTeachingFormData({...teachingFormData, year: e.target.value})}
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200"
              ...
              <FileUpload
                ...
                accept="image/*"
                type="image"
                preview={editingTeaching?.image}
                onFileSelect={(file) => setTeachingFormData({...teachingFormData, image: file})}
              />

              <FileUpload
                label="Course Materials (PDF)"
                accept=".pdf"
                type="pdf"
                onFileSelect={(file) => setTeachingFormData({...teachingFormData, pdf: file})}
              />
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="Full course content and curriculum"
                  rows={8}
                  className="rounded-xl border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200"
                />
              </div>
          ...
          <DialogContent className="max-w-2xl">
            ...
            <div className="space-y-6">
              ...
              <FileUpload
                ...
                accept="image/*"
                type="image"
                preview={editingCrawl?.image}
                onFileSelect={(file) => setCrawlFormData({...crawlFormData, image: file})}
              />
